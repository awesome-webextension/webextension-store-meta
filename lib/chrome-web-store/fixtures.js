...
module.exports = async function fixtures({ maxFixtures, proxyAgent }) {
  ...
  exts.set('ekbmhggedfdlajiikminikhcjffbleac', {
    id: 'ekbmhggedfdlajiikminikhcjffbleac',
    url: 'https://chromewebstore.google.com/detail/ekbmhggedfdlajiikminikhcjffbleac',
  })
